                            ...
                            <form action="/presensi/monitoring" method="GET">
                                <div class="input-group mb-2">
                                    <input type="text" id="tanggal" value="{{ Request('tanggal') }}" name="tanggal"
                                        value="" class="form-control" placeholder="Tanggal Presensi" autocomplete="off">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-vcenter">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{!! $d->jam_out != null ? $d->jam_out : '<span
                                            class="badge bg-danger">Belum Absen</span>'
                                        !!}</td>
                                    <td class="text-center">
                                        @if ($d->jam_out != null)
