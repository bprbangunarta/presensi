            ...
            <div class="card card-lg">
                <div class="card-body">
                    <div class="row fs-5" style="margin-top: -20px;">
                        ...
                        <div class="col-12">
                            <img src="https://seeklogo.com/images/N/ninja-xpress-logo-860168EFBE-seeklogo.com.png"
                        ...
                        <div class="col-12 mb-2">
                            <h4 class="text-center">LAPORAN ATTENDANCE PERIODE {{ strtoupper($namabulan[$bulan]) }}
                                {{ $tahun }}</h4>
                        </div>
                    </div>
